...
// $Rev: 52393 $
// File generated on 15/9/2023 11:27:23 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Users\elect\OneDrive\Documentos\Embarcadero\Studio\Projects\mllib\mllib (1)
...
// *********************************************************************//
  IMPService = interface(IDispatch)
    ...
    function GetPos(const PosId: WideString; const ExternalId: WideString;
                    const ExternalStoreId: WideString; const StoreId: WideString;
                    const Category: WideString): OLE_CANCELBOOL; safecall;
    ...
    function DeletePaymentIntent(const DeviceId: WideString; const PaymentIntentId: WideString): OLE_CANCELBOOL; safecall;
    ...
    function GetStores(const UserId: WideString; const ExternalId: WideString): OLE_CANCELBOOL; safecall;
    function Get_UserId: WideString; safecall;
    function Get_PosId: WideString; safecall;
    function Get_GetStoresResponse: IJsonObject; safecall;
    procedure ConfigureStore; safecall;
    function DeleteStore(const UserId: WideString; const StoreId: WideString): OLE_CANCELBOOL; safecall;
    function CreatePos(const Name: WideString; fixed_amount: OLE_CANCELBOOL; category: Integer;
                       const store_id: WideString): OLE_CANCELBOOL; safecall;
    function DeletePos(const PosId: WideString): OLE_CANCELBOOL; safecall;
    function UpdatePos(const PosId: WideString; const Data: IJsonObject): OLE_CANCELBOOL; safecall;
    function UpdateStore(const UserId: WideString; const StoreId: WideString;
                         const Data: IJsonObject): OLE_CANCELBOOL; safecall;
    function QRCreateOrder(const Data: IJsonObject): OLE_CANCELBOOL; safecall;
    function newUuid: WideString; safecall;
    function WaitQRPayment: OLE_CANCELBOOL; safecall;
    function Get_SandboxMode: OLE_CANCELBOOL; safecall;
    procedure Set_SandboxMode(Value: OLE_CANCELBOOL); safecall;
    function Get_Error: WideString; safecall;
    function QRDeleteOrder(const UserId: WideString; const ExternalPosId: WideString): OLE_CANCELBOOL; safecall;
    function GetUsersMe: OLE_CANCELBOOL; safecall;
    function Get_GetUsersMeResponse: IJsonObject; safecall;
    function Get_GetPaymentResponseAsObj: IPayment; safecall;
    ...
    property PosId: WideString read Get_PosId;
    property GetStoresResponse: IJsonObject read Get_GetStoresResponse;
    property SandboxMode: OLE_CANCELBOOL read Get_SandboxMode write Set_SandboxMode;
    property Error: WideString read Get_Error;
    property GetUsersMeResponse: IJsonObject read Get_GetUsersMeResponse;
    property GetPaymentResponseAsObj: IPayment read Get_GetPaymentResponseAsObj;
  end;
...
// *********************************************************************//
  IMPServiceDisp = dispinterface
    ...
    function GetPos(const PosId: WideString; const ExternalId: WideString;
                    const ExternalStoreId: WideString; const StoreId: WideString;
                    const Category: WideString): OLE_CANCELBOOL; dispid 216;
    ...
    function DeletePaymentIntent(const DeviceId: WideString; const PaymentIntentId: WideString): OLE_CANCELBOOL; dispid 227;
    ...
    function GetStores(const UserId: WideString; const ExternalId: WideString): OLE_CANCELBOOL; dispid 207;
    property UserId: WideString readonly dispid 209;
    property PosId: WideString readonly dispid 202;
    property GetStoresResponse: IJsonObject readonly dispid 235;
    procedure ConfigureStore; dispid 236;
    function DeleteStore(const UserId: WideString; const StoreId: WideString): OLE_CANCELBOOL; dispid 237;
    function CreatePos(const Name: WideString; fixed_amount: OLE_CANCELBOOL; category: Integer;
                       const store_id: WideString): OLE_CANCELBOOL; dispid 238;
    function DeletePos(const PosId: WideString): OLE_CANCELBOOL; dispid 239;
    function UpdatePos(const PosId: WideString; const Data: IJsonObject): OLE_CANCELBOOL; dispid 240;
    function UpdateStore(const UserId: WideString; const StoreId: WideString;
                         const Data: IJsonObject): OLE_CANCELBOOL; dispid 241;
    function QRCreateOrder(const Data: IJsonObject): OLE_CANCELBOOL; dispid 242;
    function newUuid: WideString; dispid 243;
    function WaitQRPayment: OLE_CANCELBOOL; dispid 244;
    property SandboxMode: OLE_CANCELBOOL dispid 245;
    property Error: WideString readonly dispid 246;
    function QRDeleteOrder(const UserId: WideString; const ExternalPosId: WideString): OLE_CANCELBOOL; dispid 247;
    function GetUsersMe: OLE_CANCELBOOL; dispid 248;
    property GetUsersMeResponse: IJsonObject readonly dispid 249;
    property GetPaymentResponseAsObj: IPayment readonly dispid 250;
  end;
...
// *********************************************************************//
  IPayment = interface(IDispatch)
    ...
    function Get_transaction_amount: Double; safecall;
    ...
    function Get_date_last_updated: WideString; safecall;
    function Get_amount_refunded: Double; safecall;
    function Get_date_of_expiration: WideString; safecall;
    function Get_operation_type: WideString; safecall;
    function Get_issuer_id: WideString; safecall;
    function Get_payment_method_id: WideString; safecall;
    function Get_description: WideString; safecall;
    function Get_live_mode: WideString; safecall;
    function Get_payment_type_id: WideString; safecall;
    property id: WideString read Get_id;
    property transaction_amount: Double read Get_transaction_amount;
    ...
    property date_last_updated: WideString read Get_date_last_updated;
    property amount_refunded: Double read Get_amount_refunded;
    property date_of_expiration: WideString read Get_date_of_expiration;
    property operation_type: WideString read Get_operation_type;
    property issuer_id: WideString read Get_issuer_id;
    property payment_method_id: WideString read Get_payment_method_id;
    property description: WideString read Get_description;
    property live_mode: WideString read Get_live_mode;
    property payment_type_id: WideString read Get_payment_type_id;
  end;
...
// *********************************************************************//
  IPaymentDisp = dispinterface
    ...
    property transaction_amount: Double readonly dispid 202;
    ...
    property date_last_updated: WideString readonly dispid 209;
    property amount_refunded: Double readonly dispid 210;
    property date_of_expiration: WideString readonly dispid 211;
    property operation_type: WideString readonly dispid 212;
    property issuer_id: WideString readonly dispid 213;
    property payment_method_id: WideString readonly dispid 214;
    property description: WideString readonly dispid 215;
    property live_mode: WideString readonly dispid 216;
    property payment_type_id: WideString readonly dispid 217;
  end;
