...
AmodeloFiscal[03]='EPSON TM2000'
AmodeloFiscal[04]='HASAR 614'
AmodeloFiscal[05]='HASAR 615'
AmodeloFiscal[06]='HASAR PR4'
...
PUBLIC TICKET_NOTA_CREDITO_A,TICKET_NOTA_CREDITO_B,TICKET_RECIBO_X,TICKET_NOTA_CREDITO_C,NOTA_CREDITO_C
...
COTIZACION								= 117
RECIBO_X								= 120
TICKET_NOTA_CREDITO_A					= 82&&52
TICKET_NOTA_CREDITO_B					= 83&&53
TICKET_NOTA_CREDITO_C					= 53
TICKET_RECIBO_X							= 54
...
FarmoArray(09,09,@AOcx01CompModelo,MODELO_715,TICKET_FACTURA_A,TICKET_FACTURA_B,TICKET_C,RECIBO_X;
															   ,NOTA_DEBITO_A,NOTA_DEBITO_B,NOTA_CREDITO_A,NOTA_CREDITO_B,NOTA_CREDITO_C)	
FarmoArray(10,09,@AOcx01CompModelo,MODELO_715_201,TICKET_FACTURA_A,TICKET_FACTURA_B,TICKET_C,RECIBO_X;
															  ,NOTA_DEBITO_A,NOTA_DEBITO_B,NOTA_CREDITO_A,NOTA_CREDITO_B,NOTA_CREDITO_C)	
...
FarmoArray(09,09,@AOcx05CompModelo,MODELO_715,TICKET_FACTURA_A,TICKET_FACTURA_B,TICKET_C,TICKET_NOTA_DEBITO_A,TICKET_NOTA_DEBITO_B;
														        ,TICKET_NOTA_CREDITO_A,TICKET_NOTA_CREDITO_B,TICKET_RECIBO_X,TICKET_NOTA_CREDITO_C)	
FarmoArray(10,09,@AOcx05CompModelo,MODELO_715_201,TICKET_FACTURA_A,TICKET_FACTURA_B,TICKET_C,TICKET_NOTA_DEBITO_A,TICKET_NOTA_DEBITO_B;
														        ,TICKET_NOTA_CREDITO_A,TICKET_NOTA_CREDITO_B,TICKET_RECIBO_X,TICKET_NOTA_CREDITO_C)	
...
PUBLIC COPIA_NO_COPIAS,COPIA_ORIGINAL,COPIA_DUPLICADO,COPIA_TRIPLICADO,COPIA_CUADRUPLICADO,CORTE_TOTAL,NO_CORTE,CORTE_PARCIAL
...
FiscalErrors[10] =      ""
FiscalErrors[11] =      ""
FiscalErrors[12] =      "Es necesario hacer un cierre Z"
...
PrinterErrors[04] = "Impresora fuera de linea"
...
PrinterErrors[13] = ""
PrinterErrors[14] = ""
PrinterErrors[15] = "Impresora sin Papel"
PrinterErrors[16] = ""
