...
Define Class ysystray As Systray Of "systray.vcx"
    IconFile = "ALERT.ICO"
    TipText = "Información del la aplicación"
    MenuTextIsMPR = .F.
    MenuText = "1;Información" 
ENDDEFINE
...
**************************************************
*-- Class:        x_frminternalsystrayuseonly (g:\vfp8\sii_adsgest\libs\systray.vcx)
*-- ParentClass:  form
*-- BaseClass:    form
*-- Time Stamp:   10/13/02 11:08:08 PM
*
