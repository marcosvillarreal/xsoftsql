...
select p.numero,p.nombre,p.codalfa as codalfaprov,isnull(c.cnombre,'GENERICO') as proveedor, m.nombre as marca,r.nombre as rubro,p.prevtaf2 as precio
...
CursorAdapterToXML('CsrExp',"c:\archivo_web\WEB.xml")
USE IN CsrExp
