...
llok = CargarTabla('leon','AfeCtacte')
...
SCAN 
	...
	SELECT CsrAnterior
	replace saldo WITH (saldo - CsrProv_Saldoant.saldo_ant) &&Restamos pq el saldo_ant postivo es un credto. y aqui el saldo negativo es  credto
ENDSCAN 
...
*!*					ENDIF 
				...
				IF llok
					...
					VALUES (lnidafectacte,lnidmaoperad,lniddebe,lnidmaoperah,lnidhaber,ABS(lnimporte))
