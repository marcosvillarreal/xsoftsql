...
llok = .t.
llok = CargarTabla('leon','Zona',.t.)
llok = CargarTabla('leon','Ctacte')
llok = CargarTabla('leon','ZonaRuta',.t.)
llok = CargarTabla('leon','Vendedor',.t.)
llok = CargarTabla('leon','Fletero',.t.)
llok = CargarTabla('leon','Ruta',.t.)
llok = CargarTabla('leon','RutaVdor',.t.)
llok = CargarTabla('leon','CabeRuta',.t.)
llok = CargarTabla('leon','CuerRuta',.t.)
...
SCAN 
	...
	IF idrutavdor#Csrrutavdor.id OR dia#VAL(SUBSTR(lcdias,i,1))
		INSERT INTO Csrcaberuta (id,idrutavdor,dia) ;
		VALUES (lnidcabeza,Csrrutavdor.id,2)
		lnidcabeza = lnidcabeza + 1
	ENDIF 
