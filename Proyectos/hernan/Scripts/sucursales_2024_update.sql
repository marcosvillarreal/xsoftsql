use mildelicias_mitre
--script de actualizacion

--Seteotermi - turno n(2)
--MovTarjeta, MovBcocar - idvalor int 
...
--update valor set regisf=0
--update valor set regisf=1 where numero in (78,7,40,15,84,17,39)

--update paraconfig set idejercicio = 1100000025 where idejercicio = 1300000026
--update detanrocaja set idejercicio = 1100000025 where idejercicio = 1300000026
--update rubroctacon set idejercicio = 1100000025 where idejercicio = 1300000026
--update valorctacon set idejercicio = 1100000025 where idejercicio = 1300000026
--update plancue set idejercicio = 1100000025 where idejercicio = 1300000026
--update detaconta set id = 1100000025 where ejercicio = 15

--update paraconta set idcuenta = 1100018246 where idejercicio = 1300000026 and numero = 30
--update paraconta set idcuenta = 1100018251 where idejercicio = 1300000026 and numero in (1,22)
--update paraconta set idcuenta = 1100018270 where idejercicio = 1300000026 and numero in (2,33)
--update paraconta set idcuenta = 1100018274 where idejercicio = 1300000026 and numero in (13,14)
--update paraconta set idcuenta = 1100018305 where idejercicio = 1300000026 and numero in (3)
--update paraconta set idcuenta = 1100018306 where idejercicio = 1300000026 and numero in (34)
--update paraconta set idcuenta = 1100018308 where idejercicio = 1300000026 and numero in (35)
--update paraconta set idcuenta = 1100018309 where idejercicio = 1300000026 and numero in (7)
--update paraconta set idcuenta = 1100018314 where idejercicio = 1300000026 and numero in (4,5,26)
--update paraconta set idcuenta = 1100018328 where idejercicio = 1300000026 and numero in (31)
--update paraconta set idcuenta = 1100018332 where idejercicio = 1300000026 and numero in (15)
--update paraconta set idcuenta = 1100018335 where idejercicio = 1300000026 and numero in (16)
--update paraconta set idcuenta = 1100018503 where idejercicio = 1300000026 and numero in (18,19,21,24)
--update paraconta set idcuenta = 1100018504 where idejercicio = 1300000026 and numero in (20,23)
--update paraconta set idejercicio = 1100000025 where idejercicio = 1300000026 
...
/****** Object:  Table [dbo].[movtarjeta]    Script Date: 21/5/2025 11:30:22 ******/
SET ANSI_NULLS ON
GO
