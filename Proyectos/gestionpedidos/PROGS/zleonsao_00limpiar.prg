...
where idejercicio = <<goapp.idejercicio>> and idsucursal = <<goapp.idsucursal>>
ENDTEXT 
...
*!*	lnSaldo			= CsrCajas.saldo

*!*	INSERT INTO Csrdetanrocaja(id,idejercicio,nrocaja,pefiscal,fecdesde,fechasta,debe,haber,saldo;
*!*		,switch,idsucursal,fecapertura);
*!*	VALUES(lniddetanrocaja,lnidejercicio,lnnrocaja,lcpefiscal,ldfecdesde,ldfechasta,lndebe,lnhaber;
*!*	,lnsaldo,lcswitch,goapp.idsucursal,DATETIME())
