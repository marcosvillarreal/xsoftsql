...
case upper(rtrim(cName)) = "USUARIOS"
	CREATE CURSOR Usuarios  (id i, idperfil i, switch c(5),nombre c(10),password c(10),idzona int)
case upper(rtrim(cName)) = "ESTADORTO"
	CREATE CURSOR EstadoRto  (id i, nomremito c(30))
