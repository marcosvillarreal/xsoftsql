...
'OSCAR' : { visual: 'user', color:'#2ecc71' , css: 'fa-user' },
'ALMACEN_Y_DESP' : { visual: 'store', color:'#e74c3c' , css: 'fa-store' },
'CLUBSOC_FOMENTO' : { visual: 'store', color:'#3498db' , css: 'fa-store' },
'MINIMERCADO' : { visual: 'store', color:'#2ecc71' , css: 'fa-store' },
'OTROS' : { visual: 'store', color:'#f39c12' , css: 'fa-store' },
'CLIENTES' : { visual: 'caret-up', color:'#9b59b6' , css: 'fa-caret-up' },
'CTA_CTE_SERVICIO' : { visual: 'caret-up', color:'#1abc9c' , css: 'fa-caret-up' },
'JUEVES_1_VROSAS_WHI' : { visual: 'calendar-day', color:'#e67e22' , css: 'fa-calendar-day' },
'JUEVES_2_CENTRO_SUDE' : { visual: 'calendar-day', color:'#34495e' , css: 'fa-calendar-day' },
...
'SIN_SECTOR' : { visual: 'calendar-day', color:'#607d8b' , css: 'fa-calendar-day' },
'VIERNES_1_BORDEUX_MA' : { visual: 'calendar-day', color:'#795548' , css: 'fa-calendar-day' },
'VIERNES_2' : { visual: 'calendar-day', color:'#ff5722' , css: 'fa-calendar-day' },
