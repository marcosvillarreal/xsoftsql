...
*stop()
sELECT distinct zona as nombre, referencia as nombre2 FROM CsrDeudor  INTO CURSOR FsrBarrio READWRITE 
...
sELECT distinct zona as nombre FROM CsrDeudor  INTO CURSOR FsrFletero READWRITE 
