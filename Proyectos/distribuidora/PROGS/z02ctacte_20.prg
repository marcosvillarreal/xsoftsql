...
SELECT * FROM CsrDeudorViej ORDER BY codcli INTO CURSOR CsrDeudor
...
SCAN 
 	...
 	SELECT CsrDeudor 
		...
		lcnombre = NombreNi(ALLTRIM(UPPER(CsrDeudor.nomcli)))
          ...
          ,totalizabonif);
		  VALUES (lnid,LTRIM((CsrDeudor.codcli)),lcnombre,UPPER(CsrDeudor.domcli),LTRIM(lccp);
		  ,lnidlocalidad,lnidprovincia,CsrDeudor.tel_cli1,lntipoiva,lccuit,lnidcategoria,0,0;
