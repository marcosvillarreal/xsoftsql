...
CREATE CURSOR FsrArticulo (codigo c(8),Articulo c(100),Precio c(20),CodBarra c(20),rubro c(50);
	,CodProveedor c(15),Marca c(50))
...
*!*		ENDIF 
	...
	IF  i+j >= lnCantCampo
		...
		INSERT INTO FsrArticulo (CODIGO,articulo,marca,precio,rubro,codbarra,codproveedor);
