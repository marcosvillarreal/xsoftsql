...
IF USED('CsrAuxPrecio')
	USE IN CsrAuxPrecio
ENDIF 
CREATE CURSOR CsrAuxPrecio (id i,idarticulo i,idproveedor i,idrubro i,idiva i;
		,costocpra n(11, 3),aumento n(6, 3),costo n(11, 3),bonif1 n(6, 3);
		,bonif2 n(6, 3),bonif3 n(6, 3),bonif4 n(6, 3),bonif1 n(6, 3);
		...
		,prepubfciva n(11, 3),fecmodi d ,endolar n(1, 0),fechaultimopre d,costoulcpra n(11, 3) ;
