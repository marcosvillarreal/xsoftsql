...
_lnidctacte			= RecuperarID('CsrCtacte',Goapp.sucursal10)
    	...
    	*stop()
    	...
    	IF ALLTRIM(cuit) <> lccuit
    		...
    		IF NOT FOUND()
				...
				,totalizabonif);
			    VALUES(_lnidctacte,lcnumero,lcnombre,lcdireccion,lccp,lnidlocalidad,lnidprovincia,lctelefono2;
				...
				_lnidctacte = _lnidctacte + 1
			ENDIF 
		ENDIF
		lncliente = VAL(CsrCtacte.cnumero )
	ENDIF 
