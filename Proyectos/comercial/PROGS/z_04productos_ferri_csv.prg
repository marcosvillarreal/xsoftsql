...
SCAN FOR !EOF()
	...
	*Almacenamos el codigo anterior para luego importar las secciones con productos
	...
	ccodpieza =STRtrim(CsrRubro.numero)+'.'+ccodalfa 
	...
	INSERT INTO  csrproducto  ( id , numero  , nombre  , codalfa , idctacte , idmarca ;
     ...
     VALUES  ( lnid , ncodigo , cnombre , ccodalfa , nidctacte , nidmarca ;
           ...
           , nidcategotipo, ccodpieza , ncotidolar , nendolar , ccodbarra14 ;
	...
	nFlete		= 0
	nfleteporce = VAL(CsrArticulo.FletePorce )
	nSegFlete	= 0&&VAL(CsrArticulo.SeFlete)
	nTotalFlete	= VAL(CsrArticulo.Flete)+ red((nFlete*nSegFlete/100),ndecimalesP)
	...
	*nPrePubFSiva	= red((nPrePubFSiva + nCostoAgre + nFleteAgre) * nIncremento,nDecimalesP)	
    ...
    INSERT INTO  prodprecio  ( id, idarticulo , idctacte , idestado  , costocpra , aumento ;
	           ...
	           , costoulcpra , preotrociva1 , preotrofsiva1 , preotrofciva1 ,DESCRIPCION,CODALFAPROV, fleteporce);
	     VALUES  ( lnidprodprecio, lnid , nidctacte , nidestado  , ncostocpra , naumento ;
	           ...
	           , ncostoulcpra , npreotrociva1 , npreotrofsiva1 , npreotrofciva1,cnombre,ccodalfaprov,nfleteporce) 
