--Scrip de Actualizacion 2014-01-15
USE [gestion]
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[afedmaope]') AND type in (N'U'))
DROP TABLE [dbo].[afedmaope]

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DTablaasi]') AND type in (N'U'))
DROP TABLE [dbo].[DTablaasi]
...
CREATE TABLE [dbo].[dmaopera](
	...
	[impresa] [int] NULL,
	[desdenumcompfac] [char](13) COLLATE Modern_Spanish_CI_AS NULL,
	[hastanumcompfac] [char](13) COLLATE Modern_Spanish_CI_AS NULL,
	[cmdcompfiscal] [char](30) COLLATE Modern_Spanish_CI_AS NULL,
...
CREATE TABLE [dbo].[dcuervari](
	...
	[subnumero] [int] NULL,
 CONSTRAINT [PK_dcuervari] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE TABLE [dbo].[afedmaope](
	[id] [numeric](12, 0) NOT NULL,
	[idcomproba] [numeric](12, 0) NOT NULL,
	[dnumcomp] [char](13) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[numcomp] [char](13) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[clasecomp] [char](1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[idprefijo] [numeric](12, 0) NOT NULL,
	[copiatkt] [numeric](2, 0) NOT NULL,
	[switch] [char](5) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[idmaopera] [numeric](12, 0) NOT NULL,
	[iddmaopera] [numeric](12, 0) NOT NULL,
 CONSTRAINT [PK_afedmaope] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY],
 CONSTRAINT [UQ_afedmaope] UNIQUE NONCLUSTERED 
(
	[idmaopera] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]

CREATE TABLE [dbo].[DTablaasi](
	[id] [numeric](12, 0) NOT NULL,
	[idmaopera] [numeric](12, 0) NOT NULL,
	...
	[tasa] [numeric](7, 2) NOT NULL,
	[convenio] [numeric](12, 2) NOT NULL,
	[impuesto] [numeric](12, 2) NOT NULL,
	[idprovincia] [int] NOT NULL,
	[numprovincia] [numeric](2, 0) NOT NULL,
	[idcuenta] [int] NOT NULL,
	[tipoconce] [char](2) COLLATE Modern_Spanish_CI_AS NOT NULL,
	[registro] [int] NOT NULL,
	[origen] [char](1) COLLATE Modern_Spanish_CI_AS NOT NULL,
	[nombreobjeto] [char](5) COLLATE Modern_Spanish_CI_AS NOT NULL,
 CONSTRAINT [PK_DTablaasi] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
