...
SCAN FOR !EOF()
	...
	INSERT INTO Csrcabeasi (id,idmaopera,idejercicio,numero,fecha,tipoasi,detalle,fechacarga,estado,switch);
    VALUES (lnidcabeza,lnid,goapp.idejercicio,lnnumero,ldfecha,lctipoasi,lcdetalle,ldfechacarga,lnestadoasto;
    ,lcswitchasto)
