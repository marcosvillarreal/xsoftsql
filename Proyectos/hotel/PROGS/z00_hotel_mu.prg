...
CREATE CURSOR CsrDeudor (Codigo c(8),Categoria c(20),Apellido c(70),Nombre c(70),Direccion c(100),CodLocalidad c(6),Localidad c(50);
...
*stop()
DO WHILE NOT EOF()
	lnCantCampo = 40 &&Hay un campo vacio
	...
	DO WHILE lnCamposLeidos<=lnMaxCamposLeidos 
		...
		DO WHILE i + j <= lnCantCampo &&Campos de CsrArti + 1
			...
			*lcIdJ			= UPPER(LimpiarCadena(IIF(j + i=1,lcCadena,lcIdJ)))
			...
			lcCodCateIVA	= UPPER(LimpiarCadena(IIF(j + i=5,lcCadena,lcCodCateIVA)))
