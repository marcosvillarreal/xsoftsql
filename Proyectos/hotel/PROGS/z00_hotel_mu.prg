...
*!*	CREATE CURSOR CsrAuxiliar (Codigo c(8),Categoria c(20),Apellido c(70),Nombre c(70),Direccion c(100),CodLocalidad c(6);
*!*			,Localidad c(50);
...
*!*			,Cuit c(15), Ocupacion c(20), FecNac c(8), Sexo c(1))
*!*			
*!*	SELECT * FROM CsrAuxiliar INTO CURSOR CsrDeudor READWRITE 
