...
DO CASE 
	...
	*agregar el campo nuevo es odata.agregarobjeto.objpago
	Create Cursor Csrpago (id i AUTOINC,numero n(3),cnombre c(25),fecha d,importe n(14,2),idcuenta n(10);
	              ...
	              ,idlocalidad i,idbanco i,nroidentificador c(50),lccuit c(13), esdigital n(1),idarqueo i)
	Sele Csrpago
ENDCASE 
