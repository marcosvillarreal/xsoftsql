...
ruta = "C:\aplicaciones\afip\"
? "ruta",ruta

*-- Generar el mensaje firmado (CMS) 
cms = WSAA.SignTRA(tra, ruta + "nuevaclave.crt", ruta + "nuevaclave.key") && Cert. Demo
...
*--? WSFE.XmlResponse
*--? "Codigo Error:", WSFE.ErrCode
? "Mensaje Error", WSFE.ErrMsg
