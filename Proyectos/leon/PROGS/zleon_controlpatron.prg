...
left join Existenc as CsrExistenc on CsrNCuerfac.idarticulo = CsrExistenc.idarticulo and isnull(CsrNCuervari.idsubarti,0) = CsrExistenc.idsubarti and CsrNCuerfac.iddeposito = CsrExistenc.iddeposito
where right(CsrFletePlanilla.switch,1)='1' and left(CsrNMaopera.switch,1)='0' and CsrExistenc.iddeposito = 1100000001
